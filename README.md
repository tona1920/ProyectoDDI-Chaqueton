...
|  HU08  | Yo como ciclista quiero que el dispositivo me muestre la hora real, ya que con el chaquetón puesto no podre traer un reloj a la muñeca | Podría hacerse| 6 | El ciclista debe colocarse la prenda inteligente (chaquetón) para después presionar un botón, este deberá presionar un botón para mandar un mensaje con la hora en tiempo real |Jessy|
## Prototipo en dibujo
